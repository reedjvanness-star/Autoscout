...
export function PriceSummary({listings,onCheck,busy,progress}:{listings:Listing[];onCheck:()=>void;busy:boolean;progress:string}){
  ...
  const checked=listings.filter(r=>checkedFullPrice(r)).length;
