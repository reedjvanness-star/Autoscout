...
for(const text of ['Savings: $7,500','$7,500 savings','Dealer discount $7,500','Optional Accessories $7,500','Down payment: $7,500','$7,500 down','$7,500/month','Deposit $7,500.00'])assert(labeledNonPurchaseAmount(text,7500),text);
