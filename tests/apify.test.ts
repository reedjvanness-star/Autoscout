...
assert.equal(input.priceMax,59000);assert.equal(input.maxResults,40);assert.equal(input.sources.length,3);assert(input.keywords[0].includes('Competition green'));
